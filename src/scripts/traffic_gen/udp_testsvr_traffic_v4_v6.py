...
SRC_IP4 = "10.3.10.132"
DEST_IP4 = "10.3.10.131"
SRC_IP6 = "2001:db8:db8::2"
DEST_IP6 = "2001:db8:db8::1"
DEST_PORT = 8080
SRC_PORT = 47777
...
class STLS1(object):
    ...
    def get_streams (self,tunables,**kwargs):
        ...
        return [self.create_stream1(args.ppsv),self.create_stream2(args.ppsi),self.create_stream3(args.ppsv),self.create_stream4(args.ppsi)]
def register():
    return STLS1()
